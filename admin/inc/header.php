...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Quản trị viên VIBADMINTON</title>
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <header class="navbar navbar-inverse">
                ...
                <!-- Logo -->
                <a href="index.html" class="navbar-brand">Quản trị website
                ...
                <ul id="widgets" class="navbar-nav-custom pull-right">
                    ...
                    <li class="">
                        ...
                        ?>
                        <a href="?act=logout" class="dropdown-toggle" data-toggle=""> Đăng xuất</b></a>
            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            <li>
                                <a href="index.html" ><i class="fa fa-fire"></i>Dashboard</a>
                            </li>
                           
                         
                            <li>
                            <a href="dsloai.php"><i class="fa fa-file-text"></i>Danh sách loại</a>
                                <ul>
                                    <li>
                                        <a href="dsloai.php"><i class="fa fa-file-text"></i>Danh sách loại</a>
                                    </li>
                                    <li>
                                        <a href="themdm.php"><i class="fa fa-exclamation-triangle"></i>Thêm loại</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="product.php"><i class="fa fa-tint"></i>Danh sách sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="themsp.php"><i class="fa fa-th"></i>Thêm sản phẩm</a>
                                    </li>
